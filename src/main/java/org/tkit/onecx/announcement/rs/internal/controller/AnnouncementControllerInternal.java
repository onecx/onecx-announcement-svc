package org.tkit.onecx.announcement.rs.internal.controller;
...
import gen.org.tkit.onecx.announcement.rs.internal.AnnouncementInternalApi;
...
public class AnnouncementControllerInternal implements AnnouncementInternalApi {
    ...
    public Response getAllProductsWithAnnouncements() {
        var productNames = dao.findProductsWithAnnouncements();
        var workspaceNames = dao.findWorkspacesWithAnnouncements();
        var results = mapper.map(productNames, workspaceNames);
